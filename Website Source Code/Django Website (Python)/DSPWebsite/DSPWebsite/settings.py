"""
Django settings for DSPWebsite project.
...
INSTALLED_APPS = [
    ...
    'DSPWebApp.apps.DspwebappConfig',
]
...
ROOT_URLCONF = 'DSPWebsite.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [r'DSPWebApp\templates'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'DSPWebsite.wsgi.application'
